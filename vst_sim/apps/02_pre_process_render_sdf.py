...
DEF_SDF_FILE = '/home/zjd/dataset/ycb_meshes_google/objects/003_cracker_box/google_512k/textured.sdf'
# DEF_SDF_FILE = '/home/zjd/dataset/ycb_meshes_google/objects/003_cracker_box/google_16k/textured.sdf'
...
if __name__ == '__main__':
    ...
    file_dir = home_dir + "/dataset/ycb_meshes_google/backup/001_backup"
    ...
    for items in obj_files:
        ...
        '''
        sf = SdfFile(items + "/google_16k/nontextured.sdf")
        of = ObjFile(items + "/google_16k/nontextured.obj")
        '''
        mesh = of.read()
        sdf = sf.read()
